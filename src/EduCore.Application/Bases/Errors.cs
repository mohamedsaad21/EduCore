...
public static class Errors
{
    ...
    public static Error IdentityEditUserFailed => new("IdentityEditUserFailed", ErrorType.BadRequest, "Failed to edit user");
    public static Error IdentityDeleteUserFailed => new("IdentityDeleteUserFailed", ErrorType.BadRequest, "Failed to delete user");
    public static Error UserIsAlreadyInstructor => new("UserIsAlreadyInstructor", ErrorType.BadRequest, "You are already an instructor");
    public static Error NoProfilePictureExists => new("NoProfilePictureExists", ErrorType.BadRequest, "No profile picture exists for this user");
    ...
    public static Error IdentityEditRoleFailed => new("IdentityEditRoleFailed", ErrorType.BadRequest, "Failed to edit role");
    public static Error IdentityDeleteRoleFailed => new("IdentityDeleteRoleFailed", ErrorType.BadRequest, "Failed to edit role");
    public static Error IdentityConfirmEmailFailed => new("IdentityConfirmEmailFailed", ErrorType.BadRequest, "Failed to confirm email");
    ...
    public static Error CourseNotFound => new("CourseNotFound", ErrorType.NotFound, "Course is not found");
    ...
    public static Error CategoryNotFound => new("CategoryNotFound", ErrorType.NotFound, "Category is not found");
    public static Error InstructorNotFound => new("InstructorNotFound", ErrorType.NotFound, "Instructor is not found");
    public static Error OrderNotFound => new("OrderNotFound", ErrorType.NotFound, "Order is not found");
    ...
    public static Error SectionNotFound => new("SectionNotFound", ErrorType.NotFound, "Section is not found");
    public static Error RoleNotFound => new("RoleNotFound", ErrorType.NotFound, "Role is not found");
    public static Error ContentNotFound => new("ContentNotFound", ErrorType.NotFound, "Content is not found");
    public static Error NotEnrolledInCourse => new("NotEnrolledInCourse", ErrorType.BadRequest, "User is not enrolled in this course");
    public static Error NoFile => new("NoFile", ErrorType.BadRequest, "No file selected or the file is empty");
    public static Error FailedToUploadFile => new("FailedToUploadFile", ErrorType.BadRequest, "An unexpected error occurred while saving the file to the server. Please try again or contact support if the issue persists");
    public static Error FailedToDeleteFile => new("FailedToDeleteFile", ErrorType.BadRequest, "An unexpected error occurred while deleting the file from the server. Please try again or contact support if the issue persists");
    public static Error UnauthorizedCourseAccess => new("UnauthorizedCourseAccess", ErrorType.BadRequest, "Access denied. Only the instructor assigned to this course has permission to perform this action");
    public static Error AlreadyGiveFeedback => new("AlreadyGiveFeedback", ErrorType.BadRequest, "You have already given feedback");
    public static Error FeedbackNotFound => new("FeedbackNotFound", ErrorType.NotFound, "Feedback is not found");
    public static Error CartNotFound => new("CartNotFound", ErrorType.NotFound, "Cart is not found");
    public static Error EmptyCart => new("EmptyCart", ErrorType.BadRequest, "Cart is empty");
    public static Error NotCompletedFullCourse => new("NotCompletedFullCourse", ErrorType.BadRequest, "User have not completed this course yet");
