...
public class GetCoursePaginatedListResponse
{
    ...
    public GetCoursePaginatedListResponse(Guid id, string title, string description, string thumbnail, decimal price, string status, DateTime createdAt, Guid categoryId, string instructorName, string instructorProfilePictureUrl, double? averageRating = null
