...
public class PaymentService : IPaymentService
{
    ...
    public PaymentService(IUnitOfWork unitOfWork, StripeSettings stripeSettings, IMapper mapper)
    {
    ...
    {
        var payment = await _unitOfWork.Payments.GetTableAsTracking().Include(p => p.Basket).FirstOrDefaultAsync(p => p.PaymentIntentId == paymentIntentId);
