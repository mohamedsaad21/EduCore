...
using EduCore.Application.Filters;
...
{
    [HttpGet(Router.ContentRouting.PreviewList)]
    public async Task<IActionResult> GetContentPreviewList([FromQuery] GetContentPreviewListQuery query)
    {
