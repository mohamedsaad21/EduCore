namespace EduCore.API.Contracts.Routing;
...
public static class Router
{
    ...
    public static class ContentRouting
    {
        ...
        public const string List = prefix + "/List";
        public const string PreviewList = prefix + "/PreviewList";
        public const string GetById = prefix + "/GetById" + SingleRoute;
        public const string Create = prefix + "/Create";
        public const string Edit = prefix + "/Edit";
        public const string Delete = prefix + "/Delete" + SingleRoute;
    ...
    public static class BasketRouting
    {
        ...
        public const string Add = prefix + "/Add" + "/{CourseId}";
        public const string Delete = prefix + "/Delete" + "/{CourseId}";
    ...
    public static class EnrollmentRouting
    {
        ...
        public const string Paginated = prefix + "/Paginated";
        public const string Check = prefix + "/Check-User-Enrollment/{CourseId}";
    }
    ...
    public static class PaymentRouting
    {
        ...
        public const string CreatePaymentIntent = prefix + "/CreatePaymentIntent/{BasketId}";
